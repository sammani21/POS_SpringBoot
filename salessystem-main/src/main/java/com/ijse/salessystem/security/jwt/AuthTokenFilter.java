package com.ijse.salessystem.security.jwt;
...
import com.ijse.salessystem.security.UserDetailsServiceImpl;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws IOException, ServletException {
        ...
        try {
            ...
            if(jwt != null && jwtUtils.validateToken(jwt)) {
                ...
                UserDetails userDetails = userDetailsService.loadUserByUsername(username); //extracting username and password from Salessystem
